...
def encrypt(data: str, key: str) -> bytes:
    """
    Encrypts a string using a key with AES encryption.
    """
    key = key.encode()
...
def decrypt(data: bytes, key: str) -> dict:
    """
    Decrypts a string using a key with AES encryption.
    """
    key = key.encode()
...
if __name__ == '__main__':
    ...
    decrypted_dict = decrypt(encrypted_dict, key='040kakuksksk5hs6')
